...
#RAW DOMAINS remove comments, null ips, blank space, etc.
...
#DOMAINS prepare and group exclusions
...
sort -f -u -o deadlist_tmp.txt deadlist_tmp.txt

#PIHOLE remove deadlist from domains and sort
...
#ADGUARD transform to adblock format, create blocklist, dedupe.
